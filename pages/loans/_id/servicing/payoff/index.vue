<template>
  <div>
    ...
    <b-row>
      <b-col cols="6">
        <b-card title="Payoff Information">
          <b-card-text>
            <form>
              <div class="row form-group">
                ...
                <div class="col-md-3">
                  ...
                  <input
                    ...
                    required
                    v-money="money"
                    v-model="payoff.holdback_balance"
                  >
                </div>
                <div class="col-md-3">
              ...
              <div class="row form-group">
                <div class="col-md-3">
                  ...
                  <input
                    class="form-control"
                    type="text"
                    v-model="payoff.unpaid_interest"
                    v-money="money"
                  >
                </div>
                <div class="col-md-3">
...
export default {
  props: ["loan"],
  components: { ServicingLoanNav, PayoffNav, PayoffRequest },
  data() {
    return {
      payoff: {
        payoff_date: "",
  ...
  created() {
    if (this.$route.query.id > 0) {
      this.$axios
        .get(`/v1/servicing/payoff/form/${this.$route.query.id}`)
        .then(response => {
          this.payoff.payoff_date = response.data[0].data.payoff_date;
          this.payoff.note_balance = response.data[0].data.note_balance;
          this.payoff.holdback_balance = response.data[0].data.holdback_balance;
          this.payoff.ir_balance = response.data[0].data.ir_balance;
          this.payoff.late_fees = response.data[0].data.late_fees;
          this.payoff.recording_fee = response.data[0].data.recording_fee;
          this.payoff.reconveyance_fee = response.data[0].data.reconveyance_fee;
          this.payoff.processing_fee = response.data[0].data.processing_fee;
          this.payoff.unpaid_interest = response.data[0].data.unpaid_interest;
          this.payoff.other_fees = response.data[0].data.other_fees;
          this.payoff.notes = response.data[0].data.notes;
        });
    } else {
      this.$axios
