  ...
  <div>
    <VerstoneGrid :data = "all_sales"> 
      <e-columns>
        ...
        <e-column field="transaction" headerText="Transaction"></e-column>
        ...
        <e-column field="estimated_closing_date" headerText="Project Funding Date"></e-column>
        <e-column field="status" headerText="Status" :disableHtmlEncode="false"></e-column>
...
export default {
  ...
  methods:{
    onClick: function(args) { 
      ...
      var selectedData = this.all_sales[rowIndex];   
