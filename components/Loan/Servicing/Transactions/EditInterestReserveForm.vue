<template>
  <div>
    <b-modal
      id="edit-interest-reserve"
      title="Edit Interest Reserve"
      ref="modal"
      @show="resetModal"
      @ok="handleOk"
      ok-title="Submit"
    ...
    >
      <b-form @submit.prevent="onSubmit">
        <fg-input label="Interest Reserve Name" v-model="form.name" type="text"/>
        <fg-input label="Interest Reserve Date" v-model="form.transaction_date" type="date"/>
