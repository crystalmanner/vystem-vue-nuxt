<template>
  <div>
    <VerstoneGrid :data = "pending_modifications"> 
      <e-columns>
...
export default {
  ...
  methods: {
    onClick: function(args) {        
      ...
      var selectedData = this.pending_modifications[rowIndex];    
      this.$router.push("/loans/" + selectedData.id + "/servicing/mod");        
    }
  }
};
</script>
